...
I+=1
Answer.loc[I]=[SkyServer.sqlSearch(sql=sql_query, dataRelease="DR14")]
I+=1
...
Answer.loc[I]=['mode', 'mdj','nDetect-1','parentID','nChild','extinction_r','petroRad','petroRadErr_r']
I+=1
Answer.loc[I]=[SkyServer.sqlSearch(sql="select b.mode, b.mdj, b.nDetect-1, b.parentID, b.nChild, b.extinction_r, b.petroRad, b.petroRadErr_r, from PhotoObj b where b.objID=x", dataRelease="DR14")]
I+=1
Answer.loc[I]= ['z','zerr']
I+=1
Answer.loc[I]=[SkyServer.sqlSearch(sql="select h.z,h.zerr from Photoz h where h.objID=x", dataRelease="DR14")]         
I+=1       
...
if (s):
    ...
    Answer.loc[I]=['Elliptical']
    I+=1
else:
    Answer.loc[I]=['Uncertain']
    I+=1
